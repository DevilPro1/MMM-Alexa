...
- useAlert: if true, i will use `alert` module; if false, it will use [MMM-UpdateNotification](https://github.com/bugsounet/MMM-UpdateNotification) module of @bugsounet

# Updating

One library from @devilpro1 and two from @bugsounet
